...
```{r Shahlans Graph Section, include=FALSE}
library(shiny)
library(ggplot2)
library(dplyr)
library(plotly)
...
```{r Obydahs Graph section, include=FALSE}
ui <- fluidPage(
...
```{r Sarahs Graphs Section, include=FALSE}
shiny::fluidRow(
  shiny::column(
    4,
...
```{r Rishitas Graph Section, include=FALSE}
...
```{r Zuwidyas graph section, include=FALSE}
