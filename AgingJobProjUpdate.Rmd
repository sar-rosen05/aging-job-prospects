  ...
  sidebarLayout(
    sidebarPanel(
      selectInput(
        "Select_AgeGroup",
        "Select Age Group",
        choices = unique(clean11b_data$age_group)
        ), 
    ...
    mainPanel(
      plotlyOutput("Entry_Age_Group"), 
      tableOutput("Top10_Occupations_Table")
      )
    )
  )
...
server <- function(input, output) {
  ...
  output$Top10_Occupations_Table <-renderTable({
