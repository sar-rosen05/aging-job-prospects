...
ggplot(genz_top, aes(x = factor(year), y = genz_employment, fill = occupation)) +
  geom_col() +
  labs(
    title = "Gen Z Employment by Occupation Over Time",
    subtitle = "Ages 16–24 (CPS Annual Averages)",
    x = "Year",
...
>>>>>>> 173a004fd7671b8c6ec2cce7c17a053a30eb00fa
```
