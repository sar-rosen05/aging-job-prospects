...
tabPanel(
    ...
    sidebarLayout(
      ...
      mainPanel(
        plotlyOutput("retirePlot", height = "450px"),
...
server <- function(input, output) {
    ...
    d <- retire_metrics %>%
      ...
      mutate(
        ...
        metric_label = dplyr::case_when(
          ...
          input$metric_ret == "c55" ~ "Age 55+ (thousands)",
          input$metric_ret == "c65" ~ "Age 65+ (thousands)",
          TRUE ~ "% age 55+"
        )
      )
  ...
  output$retirePlot <- renderPlotly({
    ...
    # Optional projection (simple linear trend)
    if (isTRUE(input$show_proj) && nrow(d) >= 3) {
